...
<template>
    ...
    <br/>
    <fly-rate icon='fly-icon-heart-o' @on-change='handleChange' v-model='value7' allow-half></fly-rate>
    <br/>
...
```html
<template>
    <fly-rate icon='fly-icon-heart1' size='mini' v-model='value8' allow-half></fly-rate>
    <br/>
    <fly-rate icon='fly-icon-heart1' size='normal' v-model='value9' allow-half></fly-rate>
    <br/>
    <fly-rate icon='fly-icon-heart1' size='large' v-model='value10' allow-half></fly-rate>
</template>
<script>
    export default {
        data(){
